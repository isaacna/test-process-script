...
3.  Create a new [Google Cloud Project](https://console.cloud.google.com/projectcreate).
    ...
    Set the project name to: **cdp-test-process-script-XFAhcmEp**.

4.  After clicking "Create", Google Cloud will take a second to prevision the project.
    Once it has, you will have access to the [project's dashboard](https://console.cloud.google.com/home/dashboard?project=cdp-test-process-script-XFAhcmEp).

5.  Create a [Service Account](https://console.cloud.google.com/iam-admin/serviceaccounts/create?project=cdp-test-process-script-XFAhcmEp).
...
8.  Enable the [Cloud Resource Manager API](https://console.cloud.google.com/apis/library/cloudresourcemanager.googleapis.com?project=cdp-test-process-script-XFAhcmEp).
...
10. Create a [Pulumi Access Token](https://app.pulumi.com/account/tokens).
    ...
    -   Click "Create token".
    -   Set the description to: "test-process-script-github-actions-runner".
    -   Click "Create token".
...
11. Create the GitHub repository for this deployment to live in.
    ...
    -   Set the repo name to: **test-process-script**
    -   Set the repo owner to: **isaacna**
...
12. Initialize and push the local repository to GitHub.
    ...
    -   In a terminal, while in this repository's directory, run:
        ...
        git branch -M main
        git remote add origin https://github.com/isaacna/test-process-script.git
        git push -u origin main
        ```
    -   Refresh your repository's dashboard to ensure that all files were pushed.

13. Configure [repository settings](https://github.com/isaacna/test-process-script/settings).
...
14. Navigate to [GitHub Actions History](https://github.com/isaacna/test-process-script/actions).

    -   Click on the "workflow run" tagged with "Initial commit" and "Infrastructure".
    -   Click the "Re-run jobs" dropdown.
    -   Click "Re-run all jobs".

**If all steps complete successful your web application will be viewable at: https://isaacna/github.io/test-process-script**
...
Navigate and follow the instructions in the the file: `python/cdp_test_process_script_backend/scraper.py`.
